...
future_to_params = {}
def process_completed_futures(completed_train_futures, completed_eval_futures, batchsize, log_dir):
            ...
            #for model_data in models_data:
                ...
                if isinstance(models_data, list) and models_data:
                    for model_data in models_data:
                        ...
                        add_model_data_to_metadata(model_data, batchsize)
...
if __name__=="__main__":
    ...
    for n_topics, alpha_value, beta_value, train_eval_type in random_combinations:
        ...
        if int(len(train_eval_count)) >= (BATCH_SIZE):
            ...
            process_completed_futures(completed_train_futures, completed_eval_futures, BATCH_SIZE, LOG_DIR)
            ...
            #defensive programming to ensure WAIT output list of dictionaries are empty
            eval_futures.clear()
            train_futures.clear()
            del done, not_done, done_train, done_eval, not_done_eval, not_done_train
            del create_visualizations, done_new_tasks, not_done_new_tasks, new_task, results
